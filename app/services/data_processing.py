...
def calc_response_rate(df: pd.DataFrame, company_id: str) -> float:
...
def calc_conversation_ratio(df: pd.DataFrame, company_id: str) -> float:
    # Select company tweets
    company_tweets = df[df.author_id == company_id]
...
def calc_volume_metrics(df: pd.DataFrame, company_id: str) -> float:
...
def calc_average_response_time(df: pd.DataFrame, company_id: str) -> float:
    # Select company tweets
    company_tweets = df[df.author_id == company_id]
